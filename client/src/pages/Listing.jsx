      ...
      {listing && !error && !loading && (
        <>
          ...
          <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            ...
            <ul className='flex text-green-900 font-semibold text-sm items-center gap-4 sm:gap-6 flex-wrap'>
            ...
            {currentUser && currentUser._id !== listing.userRef && !contact && (
              <button
                ...
                className='bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 p-3 my-3'
              >
                Contact Landlord
              </button>
            )}
